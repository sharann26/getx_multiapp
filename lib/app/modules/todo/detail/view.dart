...
import 'package:multi_app/app/modules/todo/detail/widgets/doing_list.dart';
import 'package:multi_app/app/modules/todo/detail/widgets/done_list.dart';
                    ...
                    suffixIcon: IconButton(
                      onPressed: () {
                        if (homeCtrl.formKey.currentState!.validate()) {
                          var success = homeCtrl.addTodo(homeCtrl.editingCtrl.text);
                          if (success) {
